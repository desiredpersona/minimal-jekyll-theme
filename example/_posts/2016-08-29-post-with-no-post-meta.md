---
layout: post
title: Post with post meta turned off
...
Add `post_meta: false` in any posts YAML front-matter to disable the post meta above posts. You can also set `post_meta: false` in jekyll's `config.yml` file to disable the post meta site wide.
